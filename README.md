...
7- Bu token'ı *discord-selfbot-kipp.py*'de *token* kısmına yazınız. (str olarak)<br>
...
4- Bu id'yi *discord-selfbot-kipp.py*'de *chat_id* kısmına yazınız. (int olarak)<br><br>
...
git clone https://github.com/kipp1337/kippsms.git
cd kippsms
